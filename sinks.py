...
class CsvSink:
    ...
    def open(self) -> None:
        ...
        self._writer = csv.DictWriter(self._fh, fieldnames=self.headers, lineterminator=self.newline)
...
class SQLiteSink:
    def __init__(self, db_path: str, table: str, schema: Dict[str, str], if_not_exists: bool = True):
        """
...
class NullSink:
    ...
    def write(self, rows: Iterable[Row]) -> None: pass
